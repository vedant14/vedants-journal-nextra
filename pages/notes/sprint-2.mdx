...
- [ ] To 50 pushups a day (I am in mumbai these two weeks, will get difficult to stay active without going to gym)
- [ ] Eat better food - going out leads to increase in calories
- [ ] Create a better process to stick with these sprints

### Work

- [ ] Finish the PRDs highlighted in the todo list
- [ ] Think about this - how can I make an out-sized impact in my job

### Side-Projects

- [ ] Get 100 visits to tiny tea kettle page
- [ ] Get clients for a cold warehousing project I am working on (Long running project)
